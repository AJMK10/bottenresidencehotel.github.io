                ...
                ?>
                    ...
                    <form role="form" action="login.php" method="post">
                        <div class="form-group" >
                            ...
                            <input placeholder="Email ici..." value="<?=$email;?>" name="email" type="email" class="form-control"/>
                        </div>

                        <div class="form-group">
                            <label for="password">Mot de passe:</label>
                            <input type="password" name="password" class="form-control" placeholder="mot de passe ici..."/>
                        </div>
...
<div class="breaks">
    ...
    <footer class="container-fluid text-center w3-text-white">
    	  ...
    	  <p>&copy; Copyright 2024-<?php echo date("Y"); ?> Hotel</a></p>
    </footer>
