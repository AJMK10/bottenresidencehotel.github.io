    ...
    <?php while($tour = mysqli_fetch_assoc($select)): ?>
       ...
       <div class="row">
         ...
         <div class="col-md-6">
           ...
           <p><b>Prix (par nuit):</b> <?= $tour['price']; ?></p>
           <p><b>details de la chambres:</b> <?= $tour['details']; ?></p>
              ...
              <div class="col-md-12">
                ...
                <form action="" method="POST" role="form">
                    ...
                    <div class="form-group col-md-6">
                        <label for=""></label>
                        <input type="text" name="name" class="form-control " id="" placeholder="Nom" <?=($tour['reservations'] <= 0)?'readonly':'';?>>
                    </div>

                    <div class="form-group col-md-6">
                        <label for=""></label>
                        <input type="number" name="people" class="form-control" id="" placeholder="Nombre de personnes"  <?=($tour['reservations'] <= 0)?'readonly':'';?>>
                    </div>

                    <div class="form-group col-md-6">
                        <label for=""></label>
                        <input type="text" name="number" class="form-control" id="" placeholder="numeros  <?=($tour['reservations'] <= 0)?'readonly':'';?>>
                    </div>

                    <div class="form-group col-md-6">
                        <label for=""></label>
                        <input type="text" name="email" class="form-control" id="" placeholder="Adresse mail"  <?=($tour['reservations'] <= 0)?'readonly':'';?>>
                    </div>

                    </div>

                    <button type="submit" name=" <?=($tour['reservations'] <= 0)?'readonly':'reserve';?>" class="btn btn-primary btn-block  <?=($tour['reservations'] <= 0)? 'disabled':'';?>">Reserver maintenant</button>
                </form>
